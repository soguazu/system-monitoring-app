...
workers.validateCheckData = function(originalCheckData) {
  ...
  originalCheckData.successCode =
    typeof originalCheckData.successCode == "object" &&
    originalCheckData.successCode instanceof Array &&
    originalCheckData.successCode.length > 0
      ? originalCheckData.successCode
      : false;
...
workers.log = function(
  ...
  //Determin the name of the logfile
